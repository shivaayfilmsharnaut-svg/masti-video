...
const SONGS_LIST = [
  // ── Bollywood Hits ──
  { id: 's1',  title: 'Kesariya',              artist: 'Arijit Singh',       duration: '4:28', cover: 'https://i.pravatar.cc/80?img=11', genre: 'Bollywood' },
  { id: 's2',  title: 'Tum Hi Ho',             artist: 'Arijit Singh',       duration: '4:10', cover: 'https://i.pravatar.cc/80?img=12', genre: 'Bollywood' },
  { id: 's3',  title: 'Balam Pichkari',        artist: 'Vishal-Shekhar',     duration: '3:52', cover: 'https://i.pravatar.cc/80?img=13', genre: 'Bollywood' },
  { id: 's4',  title: 'Galliyan',              artist: 'Ankit Tiwari',       duration: '4:55', cover: 'https://i.pravatar.cc/80?img=14', genre: 'Bollywood' },
  { id: 's5',  title: 'Raataan Lambiyan',      artist: 'Jubin Nautiyal',     duration: '3:36', cover: 'https://i.pravatar.cc/80?img=15', genre: 'Bollywood' },
  { id: 's6',  title: 'Dil Diyaan Gallan',     artist: 'Atif Aslam',         duration: '4:12', cover: 'https://i.pravatar.cc/80?img=16', genre: 'Bollywood' },
  { id: 's7',  title: 'Tera Ban Jaunga',       artist: 'Akhil',              duration: '3:48', cover: 'https://i.pravatar.cc/80?img=17', genre: 'Bollywood' },
  { id: 's8',  title: 'Hawayein',              artist: 'Arijit Singh',       duration: '4:36', cover: 'https://i.pravatar.cc/80?img=20', genre: 'Bollywood' },
  { id: 's9',  title: 'Lut Gaye',              artist: 'Jubin Nautiyal',     duration: '3:55', cover: 'https://i.pravatar.cc/80?img=21', genre: 'Bollywood' },
  { id: 's10', title: 'Phir Bhi Tumko Chahungaa', artist: 'Arijit Singh',   duration: '5:01', cover: 'https://i.pravatar.cc/80?img=19', genre: 'Bollywood' },
  { id: 's11', title: 'Dil Se Re',             artist: 'AR Rahman',          duration: '5:20', cover: 'https://i.pravatar.cc/80?img=30', genre: 'Bollywood' },
  { id: 's12', title: 'Channa Mereya',         artist: 'Arijit Singh',       duration: '4:49', cover: 'https://i.pravatar.cc/80?img=31', genre: 'Bollywood' },
  { id: 's13', title: 'Mere Rashke Qamar',     artist: 'Nusrat Fateh Ali',   duration: '4:15', cover: 'https://i.pravatar.cc/80?img=32', genre: 'Bollywood' },
  { id: 's14', title: 'Dilbaro',               artist: 'Harshdeep Kaur',     duration: '3:40', cover: 'https://i.pravatar.cc/80?img=33', genre: 'Bollywood' },
  { id: 's15', title: 'Ik Vaari Aa',           artist: 'Arijit Singh',       duration: '4:02', cover: 'https://i.pravatar.cc/80?img=34', genre: 'Bollywood' },
  { id: 's16', title: 'Kabira',                artist: 'Rekha Bhardwaj',     duration: '3:55', cover: 'https://i.pravatar.cc/80?img=35', genre: 'Bollywood' },
  { id: 's17', title: 'Tujhe Kitna Chahne Lage', artist: 'Arijit Singh',    duration: '4:30', cover: 'https://i.pravatar.cc/80?img=36', genre: 'Bollywood' },
  { id: 's18', title: 'Khairiyat',             artist: 'Arijit Singh',       duration: '3:28', cover: 'https://i.pravatar.cc/80?img=37', genre: 'Bollywood' },
  { id: 's19', title: 'Bekhayali',             artist: 'Sachet Tandon',      duration: '5:10', cover: 'https://i.pravatar.cc/80?img=38', genre: 'Bollywood' },
  { id: 's20', title: 'Teri Mitti',            artist: 'B Praak',            duration: '4:05', cover: 'https://i.pravatar.cc/80?img=39', genre: 'Bollywood' },
  // ── Punjabi ──
  { id: 's21', title: 'Pasoori',               artist: 'Ali Sethi',          duration: '3:30', cover: 'https://i.pravatar.cc/80?img=18', genre: 'Punjabi' },
  { id: 's22', title: 'Brown Munde',           artist: 'AP Dhillon',         duration: '3:10', cover: 'https://i.pravatar.cc/80?img=40', genre: 'Punjabi' },
  { id: 's23', title: 'Excuses',               artist: 'AP Dhillon',         duration: '2:58', cover: 'https://i.pravatar.cc/80?img=41', genre: 'Punjabi' },
  { id: 's24', title: 'Lover',                 artist: 'Diljit Dosanjh',     duration: '3:45', cover: 'https://i.pravatar.cc/80?img=42', genre: 'Punjabi' },
  { id: 's25', title: 'Putt Jatt Da',          artist: 'Diljit Dosanjh',     duration: '4:00', cover: 'https://i.pravatar.cc/80?img=43', genre: 'Punjabi' },
  // ── Trending / Viral ──
  { id: 's26', title: 'Photograph',            artist: 'Ed Sheeran',         duration: '4:19', cover: 'https://i.pravatar.cc/80?img=22', genre: 'International' },
  { id: 's27', title: 'Shape of You',          artist: 'Ed Sheeran',         duration: '3:53', cover: 'https://i.pravatar.cc/80?img=44', genre: 'International' },
  { id: 's28', title: 'Dynamite',              artist: 'BTS',                duration: '3:19', cover: 'https://i.pravatar.cc/80?img=45', genre: 'K-Pop' },
  { id: 's29', title: 'Butter',                artist: 'BTS',                duration: '2:44', cover: 'https://i.pravatar.cc/80?img=46', genre: 'K-Pop' },
  { id: 's30', title: 'Levitating',            artist: 'Dua Lipa',           duration: '3:23', cover: 'https://i.pravatar.cc/80?img=47', genre: 'International' },
  // ── Devotional ──
  { id: 's31', title: 'Jai Shri Ram',          artist: 'Traditional',        duration: '5:00', cover: 'https://i.pravatar.cc/80?img=48', genre: 'Devotional' },
  { id: 's32', title: 'Hanuman Chalisa',       artist: 'Hariharan',          duration: '7:30', cover: 'https://i.pravatar.cc/80?img=49', genre: 'Devotional' },
  // ── Dialogues / Viral Sounds ──
  { id: 's33', title: 'Pushpa - Jhukega Nahi', artist: 'Movie Dialogue',     duration: '0:15', cover: 'https://i.pravatar.cc/80?img=50', genre: 'Dialogue' },
  { id: 's34', title: 'RRR - Naatu Naatu',     artist: 'MM Keeravani',       duration: '3:47', cover: 'https://i.pravatar.cc/80?img=51', genre: 'Dialogue' },
  { id: 's35', title: 'KGF - Ek Dum Solid',    artist: 'Movie Sound',        duration: '0:30', cover: 'https://i.pravatar.cc/80?img=52', genre: 'Dialogue' },
];
...
const LONG_PRESS_THRESHOLD = 300; // ms — below this on release = "tap"
  ...
  const [name, setName] = useState("Rajkali Kumari");
  const [userId, setUserId] = useState("@rajkali22");
  const [bio, setBio] = useState("Digital Creator ❤️");
  ...
  const {
    data: backendVideos,
    isError: isBackendVideosError,
    error: backendVideosError,
    refetch: refetchBackendVideos,
  } = useListVideos();
...
const duration =
  ...
  try {
    const video = await cameraRef.current.recordAsync({
      ...
      // HD quality: CameraView SDK 54 uses videoQuality prop on component
    });
    ...
    if (recordedVideoUri && recordingFlowStep === 'review') {
      return (
        <View style={styles.cameraContainer}>
          ...
          <View style={[styles.cameraRightOptions, { top: 95 }]}>
            {[
        ...
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.cameraContainer}>
          <View style={styles.cameraContainer}>
            ...
            <Video
              ref={editorVideoRef}
              source={{ uri: recordedVideoUri }}
              style={{ position: 'absolute', top: 62, left: 0, width: width, height: width * (16 / 9) }}
              resizeMode="contain"
              shouldPlay
              isLooping={false}
              useNativeControls={false}
            ...
            {textOverlays.map((ov) => (
              <TouchableOpacity
                key={ov.id}
                onPress={() => setTextOverlays(prev => prev.filter(t => t.id !== ov.id))}
                style={{ position: 'absolute', top: ov.y, left: ov.x, zIndex: 50 }}
              >
            ...
            {/* Sticker overlays on video */}
            {stickerOverlays.map((s) => (
              <TouchableOpacity
                key={s.id}
                onPress={() => setStickerOverlays(prev => prev.filter(st => st.id !== s.id))}
                style={{ position: 'absolute', top: s.y, left: s.x, zIndex: 50 }}
              >
            ...
            {/* ── TOP BAR ── */}
            <View style={flowStyles.edTopBar}>
            ...
            {editorActiveTool === 'effects' && (
              <View style={{ position: 'absolute', bottom: Platform.OS === 'ios' ? 100 : 88, left: 0, right: 0, backgroundColor: 'rgba(0,0,0,0.85)', paddingTop: 14, paddingBottom: 10, zIndex: 90 }}>
                <Text style={{ color: '#fff', fontSize: 13, fontWeight: '700', paddingHorizontal: 16, marginBottom: 10 }}>🎨 Filter aur Effects</Text>
                <Text style={{ color: '#888', fontSize: 11, paddingHorizontal: 16, marginBottom: 8 }}>Filter</Text>
                <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ paddingHorizontal: 12, gap: 10 }}>
                  {['Normal','Vintage','B&W','Warm','Cool','Vibrant','Drama','Fade'].map(f => (
                    <TouchableOpacity key={f} onPress={() => setSelectedFilter(f)} style={{ alignItems: 'center', gap: 6 }}>
                      <View style={{ width: 56, height: 56, borderRadius: 8, backgroundColor: f === 'Normal' ? '#555' : f === 'Vintage' ? '#8B6914' : f === 'B&W' ? '#888' : f === 'Warm' ? '#C0612B' : f === 'Cool' ? '#2B7BC0' : f === 'Vibrant' ? '#C02BD9' : f === 'Drama' ? '#111' : '#A0A0A0', borderWidth: selectedFilter === f ? 2 : 0, borderColor: '#FE2C55' }} />
                      <Text style={{ color: selectedFilter === f ? '#FE2C55' : '#aaa', fontSize: 11 }}>{f}</Text>
                    </TouchableOpacity>
                  ))}
                </ScrollView>
                <Text style={{ color: '#888', fontSize: 11, paddingHorizontal: 16, marginTop: 12, marginBottom: 8 }}>Effect</Text>
                <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ paddingHorizontal: 12, gap: 10, paddingBottom: 4 }}>
                  {['None','Sparkle','Blur','Glow','Zoom','Shake','Flash','Mirror'].map(e => (
                    <TouchableOpacity key={e} onPress={() => setSelectedEffect(e)} style={{ paddingHorizontal: 14, paddingVertical: 7, borderRadius: 20, backgroundColor: selectedEffect === e ? '#FE2C55' : '#2A2A2A', borderWidth: selectedEffect === e ? 0 : 1, borderColor: '#444' }}>
                      <Text style={{ color: selectedEffect === e ? '#fff' : '#aaa', fontSize: 12, fontWeight: '600' }}>{e}</Text>
                    </TouchableOpacity>
                  ))}
                </ScrollView>
              </View>
            ...
            {/* ── AUDIO / VOICE panel ── */}
            {editorActiveTool === 'audio' && (
              <View style={{ position: 'absolute', bottom: Platform.OS === 'ios' ? 100 : 88, left: 0, right: 0, backgroundColor: 'rgba(0,0,0,0.85)', paddingHorizontal: 16, paddingVertical: 14, zIndex: 90 }}>
                <Text style={{ color: '#fff', fontSize: 13, fontWeight: '700', marginBottom: 12 }}>🎵 Audio Settings</Text>
                {/* Music selector */}
                <TouchableOpacity onPress={() => setShowMusicModal(true)} style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: '#1A1A1A', borderRadius: 10, padding: 12, marginBottom: 14 }}>
                  <Ionicons name="musical-notes" size={20} color="#FE2C55" style={{ marginRight: 10 }} />
                  <View style={{ flex: 1 }}>
                    <Text style={{ color: '#fff', fontSize: 14, fontWeight: '600' }}>{selectedSong ? selectedSong.title : 'Gana Chunno'}</Text>
                    <Text style={{ color: '#888', fontSize: 11, marginTop: 2 }}>{selectedSong ? selectedSong.artist : 'Koi gana nahi chuna'}</Text>
                  </View>
                  <Ionicons name="chevron-forward" size={16} color="#555" />
                </TouchableOpacity>
                {/* Volume slider */}
                <Text style={{ color: '#aaa', fontSize: 12, marginBottom: 6 }}>🔊 Volume: {editorVolume}%</Text>
                <View style={{ height: 4, backgroundColor: '#333', borderRadius: 2, marginBottom: 4 }}>
                  <View style={{ height: 4, width: `${editorVolume}%`, backgroundColor: '#FE2C55', borderRadius: 2 }} />
                </View>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 14 }}>
                  <TouchableOpacity onPress={() => setEditorVolume(v => Math.max(0, v - 10))} style={{ padding: 6 }}><Ionicons name="volume-low" size={20} color="#888" /></TouchableOpacity>
                  <TouchableOpacity onPress={() => setEditorVolume(v => Math.min(100, v + 10))} style={{ padding: 6 }}><Ionicons name="volume-high" size={20} color="#FE2C55" /></TouchableOpacity>
                </View>
                {/* Voice effects */}
                <Text style={{ color: '#aaa', fontSize: 12, marginBottom: 8 }}>🎙️ Voice Effect</Text>
                <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ gap: 8 }}>
                  {VOICE_EFFECTS.map(v => (
                    <TouchableOpacity key={v} onPress={() => setEditorVoiceEffect(v)} style={{ paddingHorizontal: 14, paddingVertical: 7, borderRadius: 20, backgroundColor: editorVoiceEffect === v ? '#FE2C55' : '#2A2A2A', borderWidth: editorVoiceEffect === v ? 0 : 1, borderColor: '#444' }}>
                      <Text style={{ color: editorVoiceEffect === v ? '#fff' : '#aaa', fontSize: 12, fontWeight: '600' }}>{v}</Text>
                    </TouchableOpacity>
                  ))}
                </ScrollView>
              </View>
            ...
            {editorActiveTool === 'text' && (
              <View style={{ position: 'absolute', bottom: Platform.OS === 'ios' ? 100 : 88, left: 0, right: 0, backgroundColor: 'rgba(0,0,0,0.85)', paddingHorizontal: 16, paddingVertical: 14, zIndex: 90 }}>
                <Text style={{ color: '#fff', fontSize: 13, fontWeight: '700', marginBottom: 10 }}>✍️ Text Add karo</Text>
                {/* Text input */}
                <View style={{ backgroundColor: '#1A1A1A', borderRadius: 10, paddingHorizontal: 12, paddingVertical: 8, marginBottom: 12, flexDirection: 'row', alignItems: 'center' }}>
                  <TextInput
                    style={{ flex: 1, color: editorTextColor, fontSize: editorTextSize * 0.6, fontWeight: '700' }}
                    placeholder="Kuch likho..."
                    placeholderTextColor="#555"
                    value={editorTextInput}
                    onChangeText={setEditorTextInput}
                    autoCorrect={false}
                    maxLength={60}
                  />
                  {editorTextInput.length > 0 && (
                    <TouchableOpacity onPress={() => {
                      setTextOverlays(prev => [...prev, { id: Date.now().toString(), text: editorTextInput, color: editorTextColor, size: editorTextSize, x: width / 2 - 60, y: height / 2 - 40 }]);
                      setEditorTextInput('');
                    }} style={{ backgroundColor: '#FE2C55', borderRadius: 8, paddingHorizontal: 12, paddingVertical: 6, marginLeft: 8 }}>
                      <Text style={{ color: '#fff', fontWeight: '700', fontSize: 13 }}>Add</Text>
                    </TouchableOpacity>
                  )}
                </View>
                {/* Color picker */}
                <Text style={{ color: '#888', fontSize: 11, marginBottom: 8 }}>Color chunno</Text>
                <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ gap: 10, marginBottom: 12 }}>
                  {TEXT_COLORS.map(col => (
                    <TouchableOpacity key={col} onPress={() => setEditorTextColor(col)} style={{ width: 32, height: 32, borderRadius: 16, backgroundColor: col, borderWidth: editorTextColor === col ? 3 : 1, borderColor: editorTextColor === col ? '#FE2C55' : '#555' }} />
                  ))}
                </ScrollView>
                {/* Size */}
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
                  <Text style={{ color: '#888', fontSize: 11 }}>Size: {editorTextSize}</Text>
                  <TouchableOpacity onPress={() => setEditorTextSize(s => Math.max(14, s - 4))} style={{ padding: 4 }}><Ionicons name="remove-circle-outline" size={22} color="#888" /></TouchableOpacity>
                  <TouchableOpacity onPress={() => setEditorTextSize(s => Math.min(48, s + 4))} style={{ padding: 4 }}><Ionicons name="add-circle-outline" size={22} color="#FE2C55" /></TouchableOpacity>
                  {textOverlays.length > 0 && (
                    <TouchableOpacity onPress={() => setTextOverlays([])} style={{ marginLeft: 'auto', backgroundColor: '#2A2A2A', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 5 }}>
                      <Text style={{ color: '#aaa', fontSize: 11 }}>Sab hatao</Text>
                    </TouchableOpacity>
                  )}
                </View>
                {textOverlays.length > 0 && <Text style={{ color: '#555', fontSize: 11, marginTop: 6 }}>Tap karo text pe video mein → remove hoga</Text>}
              </View>
            )}

            {/* ── STICKERS panel ── */}
            {editorActiveTool === 'stickers' && (
              <View style={{ position: 'absolute', bottom: Platform.OS === 'ios' ? 100 : 88, left: 0, right: 0, backgroundColor: 'rgba(0,0,0,0.85)', paddingHorizontal: 16, paddingTop: 14, paddingBottom: 10, zIndex: 90 }}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
                  <Text style={{ color: '#fff', fontSize: 13, fontWeight: '700' }}>😎 Stickers</Text>
                  {stickerOverlays.length > 0 && (
                    <TouchableOpacity onPress={() => setStickerOverlays([])} style={{ backgroundColor: '#2A2A2A', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 4 }}>
                      <Text style={{ color: '#aaa', fontSize: 11 }}>Sab hatao</Text>
                    </TouchableOpacity>
                  )}
                </View>
                <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 2 }}>
                  {STICKER_EMOJIS.map((emoji, i) => (
                    <TouchableOpacity
                      key={emoji + String(i)}
                      style={{ width: (width - 32 - 10) / 9, height: 42, alignItems: 'center', justifyContent: 'center' }}
                      onPress={() => setStickerOverlays(prev => [...prev, { id: Date.now().toString() + i, emoji, size: 40, x: 40 + (i % 5) * 50, y: 120 + Math.floor(i / 5) * 60 }])}
                    >
                      <Text style={{ fontSize: 28 }}>{emoji}</Text>
                    </TouchableOpacity>
                  ))}
                </View>
                {stickerOverlays.length > 0 && <Text style={{ color: '#555', fontSize: 11, marginTop: 4, textAlign: 'center' }}>Tap karo sticker pe video mein → remove hoga</Text>}
              </View>
            )}
            ...
            <View style={flowStyles.edBottomBar}>
              {[
                ...
                { id: 'edit',     icon: 'film-outline',  label: 'Edit'     },
                ...
                >
                  <View style={[flowStyles.edToolIconCircle, editorActiveTool === tool.id && { backgroundColor: '#FE2C55' }]}>
                    <Ionicons
                      name={tool.icon}
                      size={22}
                      color="#fff"
                  ...
                  <Text style={[flowStyles.edToolLabel, editorActiveTool === tool.id && { color: '#FE2C55', fontWeight: '700' }]}>
                    {tool.label}
                  </Text>
                </TouchableOpacity>
              ))}
      ...
      return (
        <View style={[styles.cameraContainer, { backgroundColor: '#000' }]}>
          ...
          <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1 }} keyboardVerticalOffset={0}>
            <ScrollView style={{ flex: 1, marginTop: 60 }} contentContainerStyle={{ paddingBottom: 110 }} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
                  ...
                  <View style={flowStyles.ttTabRow}>
                    {[
                      ...
                      return (
                        <TouchableOpacity
                          key={tab.key}
                          onPress={() => setActiveDescTab(tab.key)}
              ...
              <View style={flowStyles.ttListCard}>
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                    ...
                    Alert.alert(
                      ...
                      undefined,
                      [
                        ...options.map(opt => ({ text: opt.label, onPress: () => setPrivacySetting(opt.key) })),
                        { text: 'Cancel', style: 'cancel' },
                      ]
                    );
                  }}
                ...
                <View style={flowStyles.ttRow}>
                  ...
                  <Text style={flowStyles.ttRowLabel}>Allow comments</Text>
                  <Switch
                    value={allowComments}
                ...
                {/* Allow Duet */}
                <View style={flowStyles.ttRow}>
                  <Ionicons name="people-circle-outline" size={20} color="#fff" style={flowStyles.ttRowIcon} />
                  <Text style={flowStyles.ttRowLabel}>Allow Duet</Text>
                  <Switch
                    value={allowDuet}
                ...
                {/* Allow Stitch */}
                <View style={flowStyles.ttRow}>
                  <Ionicons name="cut-outline" size={20} color="#fff" style={flowStyles.ttRowIcon} />
                  <Text style={flowStyles.ttRowLabel}>Allow Stitch</Text>
                  <Switch
                    value={allowStitch}
...
const FiltersModal = () => (
          ...
          <ScrollView style={{ marginBottom: 90 }}>
            {users.map((item) => (
              <View key={item.id} style={{ flexDirection: 'row', padding: 15, alignItems: 'center' }}>
                ...
                <TouchableOpacity
                  style={[styles.followBtnBlue, followingUsers.includes(item.user) && styles.followBtnGray]}
                  onPress={() => toggleFollow(item.user)}
                >
                  <MaterialCommunityIcons
                    name={followingUsers.includes(item.user)? "account-check" : "account-plus"}
                    size={18}
                    color="white"
                  />
                  <Text style={{ color: '#fff', fontSize: 14, fontWeight: 'bold', marginLeft: 6 }}>
                    {followingUsers.includes(item.user)? 'Following' : 'Follow'}
                  </Text>
                </TouchableOpacity>
              </View>
            ))}
  ...
  if (isProfile) {
    ...
    const ownProfileData = { user: userId, name, userId, bio, profileImage: profileImage || 'https://i.pravatar.cc/300?img=8', followers: ownFollowers, following: followingUsers.length, youtube, instagram, facebook };
            ...
            <View>
              ...
              <View style={styles.profileContent}>
                <View style={styles.avatarContainer}>
                  {displayUser?.profileImage? <Image source={{ uri: displayUser.profileImage }} style={styles.avatar} /> : <View style={styles.avatar} />}
                ...
                <View style={styles.buttonGroupRow}>
                  {selectedUser? (
                    <>
                      <TouchableOpacity 
                        style={[styles.followBtnBlue, followingUsers.includes(selectedUser.user) && styles.followBtnGray]} 
                  ...
                  {index === 0 && (
                    <View style={styles.videoGrid}>
                      {(isOwnProfile ? userVideos : userVideos.filter(v => v.privacy !== 'private')).map((item) => (
                        <TouchableOpacity key={item.id} style={styles.videoItem}>
                          <Video source={{ uri: item.url }} style={{ flex: 1 }} resizeMode="cover" shouldPlay={false} isMuted />
                          <View style={styles.videoViews}><Ionicons name="play" size={14} color="white" /><Text style={styles.viewsText}>1.2K</Text></View>
                        </TouchableOpacity>
                      ))}
                    </View>
                  )}
